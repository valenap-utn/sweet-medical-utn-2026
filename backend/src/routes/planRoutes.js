...
export default function planRoutes(getController) {
     ...
     */
    router.patch("/:id/especialidades", planController.agregarCoberturaEspecialidad);
     ...
     *         description: Cobertura agregada/actualizada con éxito
     */
    router.patch("/:id/practicas", planController.agregarCoberturaPractica);
     ...
     */
    router.delete("/:id/especialidades/:especialidadId", planController.quitarCoberturaEspecialidad);
     ...
     *         description: Cobertura removida con éxito
     */
    router.delete("/:id/practicas/:practicaId", planController.quitarCoberturaPractica);
