        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }} className="sm-desktop-nav">
          {!esMedico && (
            <div style={{ position: "relative" }}>
              <Link href="/carrito" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", minHeight: 44, gap: 5, padding: "8px 14px", borderRadius: 999, border: "2px solid var(--p)", color: "var(--p)", fontWeight: 700, fontSize: 12, textDecoration: "none" }}>
                📅 Turno
              </Link>
              {items.length > 0 && (
          ...
          {cargando ? null : usuario ? (
            ...
            <>
              <Link href="/login" style={{ display: "inline-flex", alignItems: "center", minHeight: 44, padding: "8px 14px", borderRadius: 999, background: "transparent", color: "var(--p)", fontWeight: 700, fontSize: 12, textDecoration: "none", border: "2px solid var(--p)" }}>
                Iniciar sesión
              </Link>
              <Link href="/registro" style={{ display: "inline-flex", alignItems: "center", minHeight: 44, padding: "8px 14px", borderRadius: 999, background: "var(--p)", color: "#fff", fontWeight: 700, fontSize: 12, textDecoration: "none", border: "2px solid var(--p)" }}>
                Crear cuenta
              </Link>
            </>
          )}
