...
export default function LoginPage() {
    ...
    const validate = () => {
        ...
        if (!form.nombreUsuario.trim()) {
            errs.nombreUsuario = "Ingresá tu nombre de usuario.";
        }

        if (!form.password) {
            errs.password = "Ingresá tu contraseña.";
        }
        ...
        <div className="login-layout" style={{minHeight: "calc(100vh - 140px)", display: "flex"}}>
            ...
            >
                ...
                <div>
                    ...
                    >
                        Tu salud,<br/>en buenas manos.
                    </h2>

                    <p
                        style={{
                            fontSize: 14,
                            color: "rgba(249,238,240,.72)",
                            lineHeight: 1.6,
                            marginBottom: 28,
                        }}
                    >
                        Accedé a tu cuenta y gestioná tus turnos, historial y cobertura desde un solo lugar.
                    </p>

                    {[
                        "Turnos disponibles al instante",
                        "Historial médico completo",
                        "Cobertura de obra social integrada",
                    ].map((f) => (
                        <div
                            key={f}
                            style={{
                ...
                <div style={{fontSize: 11, color: "rgba(249,238,240,.35)"}}>
                    © {currentYear} Sweet Medical · UTN FRBA
                </div>
            </div>
            ...
            >
                <div style={{width: "100%", maxWidth: 380}}>
                    ...
                    >
                        Iniciá sesión para gestionar tus turnos.
                    </p>
